...
export default function Section02() {
  ...
  const rightBoxStyle =
    "flex mobile:w-full mobile:pt-[16dvw] tablet:w-full tablet:pt-[10dvw] desktop:flex-1 desktop:pl-[120px] desktop:pt-0";
  ...
  return (
    <div className="p-[3vw] bg-white">
      ...
      <div className="mobile:flex-wrap tablet:flex-wrap flex">
        ...
        <div className={rightBoxStyle}>{renderTable()}</div>
      </div>
    </div>
  );
}
